...
public interface WebGranny
{
    ...
    /**
     * Points the browser to specified URL, blocks the current thread until page is loaded (be aware that some scripts
     * may still run).
     *
     * @param url to open
     ...
     */
    void handleAlert(String message, String input, boolean doAccept);
     ...
     * @param timeout number of seconds to wait for a new page to start loading. The method should return as soon as
     *     a new page is detected.
     ...
     * However, when accessing some page outside your own responsibility, you may be forced to switch off some checks.
     *
